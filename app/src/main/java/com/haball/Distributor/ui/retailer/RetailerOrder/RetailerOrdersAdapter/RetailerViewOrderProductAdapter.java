...
public class RetailerViewOrderProductAdapter extends RecyclerView.Adapter<RetailerViewOrderProductAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull RetailerViewOrderProductAdapter.ViewHolder holder, int position) {
        ...
        holder.product_code.append("        ");
        if (OrdersList.get(position).getTaxValue() != null && !OrdersList.get(position).getTaxValue().equals("null")) {
...
//        holder.UOM_value.setText(OrdersList.get(position).getUnitOFMeasure());
...
//        holder.Quantity.setText("Quantity: "+OrdersList.get(position).getOrderedQty());
//
