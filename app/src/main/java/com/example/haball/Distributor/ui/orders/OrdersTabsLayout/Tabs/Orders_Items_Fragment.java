...
public class Orders_Items_Fragment extends Fragment {
    ...
    String CompanyId = "2";
    private String PRODUCTS_URL = "http://175.107.203.97:4007/api/products/ReadProductsByCategories/";
    private String PRODUCTS_CATEGORY_URL = "http://175.107.203.97:4007/api/products/ReadCategories/0/";
        ...
        MyJsonArrayRequest sr = new MyJsonArrayRequest(Request.Method.GET, PRODUCTS_CATEGORY_URL, null, new Response.Listener<JSONArray>() {
            ...
            public void onResponse(final JSONArray result) {
                ...
                for (i = 0; i < result.length(); i++) {
                    ...
                    PRODUCTS_URL = "http://175.107.203.97:4007/api/products/ReadProductsByCategories/";
                }
            }
        }, new Response.ErrorListener() {
            @Override
