...
public class RetailerPaymentAdapter extends RecyclerView.Adapter<RetailerPaymentAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull RetailerPaymentAdapter.ViewHolder holder, final int position) {
        ...
        if(paymentsList.get(position).getStatus().equals("0")){
            ...
            holder.tv_status.setText("Un-Paid");
        }
        ...
        holder.menu_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(context, "Action Button", Toast.LENGTH_LONG).show();
                if (paymentsList.get(position).getPrepaidStatusValue().equals("Un-Paid")) {
                    ...
                    popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                        ...
                        public boolean onMenuItemClick(MenuItem item) {
                            switch (item.getItemId()) {
                                case R.id.view_edit:
                                    Toast.makeText(context, "View Edit", Toast.LENGTH_LONG).show();
...
//                                fragmentTransaction.commit();
                                ...
                                case R.id.view_delete:
                                    Toast.makeText(context, "View Delete", Toast.LENGTH_LONG).show();
                                    break;
                            }
                            return false;
                        }
                ...
                } else if (paymentsList.get(position).getPrepaidStatusValue().equals("Paid")) {
                    final PopupMenu popup = new PopupMenu(context, view);
                    MenuInflater inflater = popup.getMenuInflater();
